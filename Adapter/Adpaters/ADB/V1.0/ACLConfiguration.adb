...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ACLConfiguration">
        <AESDK:instanceId>ACLConfiguration</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
                <AESDK:name>ACLConfigPublisher</AESDK:name>
            </AESDK:startComponent>
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
        ...
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.ACLConfigPublisher</AESDK:jmsPublisher>
            </AESDK:producers>
        </AESDK:deployment>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/ACLConfiguration.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic/ACLConfigPublisher</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic</AESDK:resource>
                    <AESDK:children>ACLConfigPublisher</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic/ACLConfigPublisher</AESDK:resource>
                    <AESDK:children>P_ACL_Config</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic/ACLConfigPublisher</AESDK:resource>
                    <AESDK:description>Created for service ACLConfigPublisher.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:name>ACLConfigPublisher</ADB:name>
                <ADB:connectionFactoryType>2</ADB:connectionFactoryType>
                <ADB:publishingTable>P_ACL_Config</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ACLConfiguration.aeschema#class.P_ACL_Config</ADB:classReference>
                <ADB:sourceTable>ACL_Config</ADB:sourceTable>
                <ADB:columnsToPublish>URI</ADB:columnsToPublish>
                <ADB:columnsToPublish>SOAPAction</ADB:columnsToPublish>
                <ADB:columnsToPublish>SourceIP</ADB:columnsToPublish>
                <ADB:columnsToPublish>Allow</ADB:columnsToPublish>
                <ADB:columnsToPublish>Enable</ADB:columnsToPublish>
                <ADB:columnsToPublish>CreateDate</ADB:columnsToPublish>
                <ADB:columnsToPublish>CreateUser</ADB:columnsToPublish>
                <ADB:columnsToPublish>ModifyDate</ADB:columnsToPublish>
                <ADB:columnsToPublish>ModifyUser</ADB:columnsToPublish>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_ACL_Config</ADB:name>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>trend.pls.PartnerInt.ACL_Notification</ADB:destination>
                <ADB:endpointReference isRef="true">#jmsProducer.ACLConfigPublisher</ADB:endpointReference>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/Adpaters/ADB/V1.0/ACLConfiguration.adb#jmsSession.JMSTopic</ADB:sessionReference>
            </ADB:publisher>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\ACLConfiguration.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ACLConfigPublisher">
        ...
        <AEService:destination>trend.pls.PartnerInt.ACL_Notification</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/ACLConfiguration.aeschema#class.P_ACL_Config</AEService:class>
