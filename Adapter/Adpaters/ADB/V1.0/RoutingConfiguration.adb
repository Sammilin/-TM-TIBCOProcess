...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="RoutingConfiguration">
        <AESDK:instanceId>RoutingConfiguration</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
                <AESDK:name>RoutingConfigPublisher</AESDK:name>
            </AESDK:startComponent>
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
        ...
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.RoutingConfigPublisher</AESDK:jmsPublisher>
            </AESDK:producers>
        </AESDK:deployment>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/RoutingConfiguration.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic/RoutingConfigPublisher</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    ...
                    <AESDK:children>ADBHawkDefault,ADBAgentJmsSession,JMSTopic,ADBAgentRvSession,ADBRvSession</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic</AESDK:resource>
                    <AESDK:children>RoutingConfigPublisher</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic/RoutingConfigPublisher</AESDK:resource>
                    <AESDK:children>P_Routing_Config</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSTopic/RoutingConfigPublisher</AESDK:resource>
                    <AESDK:description>Created for service RoutingConfigPublisher.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
                <AESDK:args>--run --propFile</AESDK:args>
                <AESDK:exe>C:\tibco\adapter\adadb\6.0\bin\adbagent.exe</AESDK:exe>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:name>RoutingConfigPublisher</ADB:name>
                <ADB:connectionFactoryType>2</ADB:connectionFactoryType>
                <ADB:publishingTable>P_Routing_Config</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/RoutingConfiguration.aeschema#class.P_Routing_Config</ADB:classReference>
                <ADB:sourceTable>Routing_Config</ADB:sourceTable>
                <ADB:columnsToPublish>url</ADB:columnsToPublish>
                <ADB:columnsToPublish>soap_action</ADB:columnsToPublish>
                <ADB:columnsToPublish>type</ADB:columnsToPublish>
                <ADB:columnsToPublish>destination</ADB:columnsToPublish>
                <ADB:columnsToPublish>enable</ADB:columnsToPublish>
                <ADB:columnsToPublish>create_date</ADB:columnsToPublish>
                <ADB:columnsToPublish>create_user</ADB:columnsToPublish>
                <ADB:columnsToPublish>modify_date</ADB:columnsToPublish>
                <ADB:columnsToPublish>modify_user</ADB:columnsToPublish>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_Routing_Config</ADB:name>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>trend.pls.PartnerInt.Routing_Notification</ADB:destination>
                <ADB:endpointReference isRef="true">#jmsProducer.RoutingConfigPublisher</ADB:endpointReference>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/Adpaters/ADB/V1.0/RoutingConfiguration.adb#jmsSession.JMSTopic</ADB:sessionReference>
            </ADB:publisher>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:defaultDataSource xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                <ADB:name>%%Adpaters/ADB/V1.0/ODBC_DNS_Routing%%</ADB:name>
                <ADB:user>%%Resources/Database/MT-Master/UserName%%</ADB:user>
                <ADB:driver>tibcosoftwareinc.jdbc.sqlserver.SQLServerDriver</ADB:driver>
                <ADB:url>%%Resources/Database/MT-Master/URL%%</ADB:url>
                <ADB:disConnCode/>
                <ADB:dbmsType>SQLSERVER</ADB:dbmsType>
                <ADB:password>%%Resources/Database/MT-Master/Password%%</ADB:password>
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\RoutingConfiguration.sql</ADB:scriptFileName>
    ...
    <AEService:jmsSession xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="session.JMS" name="JMSTopic">
        ...
        <AEService:providerUrl>%%Resources/JMS/EMSSERVER01/SERVER%%</AEService:providerUrl>
        <AEService:providerCtxFactory>com.tibco.tibjms.naming.TibjmsInitialContextFactory</AEService:providerCtxFactory>
        <AEService:connUsername>%%Resources/JMS/EMSSERVER01/ID%%</AEService:connUsername>
        <AEService:connPassword>%%Resources/JMS/EMSSERVER01/PWD%%</AEService:connPassword>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="RoutingConfigPublisher">
        ...
        <AEService:destination>trend.pls.PartnerInt.Routing_Notification</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/RoutingConfiguration.aeschema#class.P_Routing_Config</AEService:class>
